(function () {
    ...
    var stageDom = document.getElementById((window._mrmcp || {})['script_id'] || "Mugeda_682864ebf66400c1a40de39d")

    _mrmcp = (typeof _mrmcp == 'undefined') ? {} : _mrmcp;
_mrmcp['campaign_id'] = 'none';
_mrmcp['owner_id'] = '682853268a3b2002d10157cb';
_mrmcp['creative_id'] = '682864ebf66400c1a40de39d';
_mrmcp['ga_url'] = _mrmcp['ga_url'] || (('https:' == document.location.protocol ? 'https://' : 'http://') + 'card.mugeda.com/weixin/card/ga.js');
_mrmcp['width'] = _mrmcp['width'] || 1280;
_mrmcp['height'] = _mrmcp['height'] || 720;
_mrmcp['type'] = 'smart';
_mrmcp['title'] = 'webpage';
_mrmcp['build_number'] = parseInt('412');
_mrmcp['publish_time'] = 'Sat May 17 2025 18:52:36 GMT+0800 (China Standard Time)';
_mrmcp['last_modified'] = '';
_mrmcp['jsapi_config_url'] = '';
_mrmcp['stat_host'] = 'https://682864ebf66400c1a40de39d.stat.mugeda.com/stats/c.gif';
...
var version = _mrmcp['version'] = _mrmcp['version'] != null ? _mrmcp['version'] : '0.4.12';
...
window['Mugeda']['Loader'] = function (dom, hasScript, _mrmcp) {
    ...
    if(!Mugeda['css3PlayerLoaded']) {
        ...
        loadRes(1, jsPath + that.crid + ".js?publishTime=1747479156372", [], undefined, function(callback){
            var chk = function(){
...
Mugeda.Loader.prototype.start = function () {
    if (2 == Mugeda.css3PlayerLoaded) {
        ...
        Mugeda['startAnimation']("id_" + this.crid, false ? "actions_" + this.crid + ".js?publishTime=1747479156372" : "", a, this.resDir, this.name, null, this._mrmcp)
    }
    else {
